  ...
  (function($, window) {
    ...
    Tour = (function() {
      ...
      Tour.prototype._showPopover = function(step, i) {
        ...
        nav = [];
        if (step.prev >= 0) {
          nav.push("<a href='#" + step.prev + "' class='prev'>&laquo; Anterior</a>");
        }
        if (step.next >= 0) {
          nav.push("<a href='#" + step.next + "' class='next'>Siguiente &raquo;</a>");
        }
        content += nav.join(" | ");
        content += "<a href='#' class='pull-right end'>Terminar Tour</a>";
